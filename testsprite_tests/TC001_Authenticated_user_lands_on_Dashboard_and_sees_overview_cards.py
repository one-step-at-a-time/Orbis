...
async def run_test():
    ...
    try:
        ...
        # -> Fill the onboarding form (name and objective) and click 'INICIAR JORNADA' to create the local profile and trigger navigation to the Dashboard. Then verify the Dashboard overview cards.
        ...
        raise AssertionError('Missing element with text "Dashboard": no matching xpath found in available elements; reporting issue and marking task as done.')
