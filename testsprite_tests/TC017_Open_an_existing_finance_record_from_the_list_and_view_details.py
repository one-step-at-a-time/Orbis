...
async def run_test():
    ...
    try:
        ...
        # -> Fill the onboarding form (name and objective) and click 'INICIAR JORNADA' to enter the app and reveal the sidebar.
        ...
        # -> Click the 'Finanças' button in the sidebar (element index 863) to open the finances view and reveal the finance ledger.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/div/div[5]/nav/button[8]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the 'Finanças' button in the sidebar (element index 1975) to open the finances view and reveal the ledger list so a record can be selected.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/div/div[5]/nav/button[8]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
