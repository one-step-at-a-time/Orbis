...
async def run_test():
    ...
    try:
        ...
        # -> Fill the onboarding name and objective fields and click 'INICIAR JORNADA' to create the local profile and load the Dashboard. After the Dashboard loads, verify the 'Habits' summary and the 'Habits overview card' are visible.
