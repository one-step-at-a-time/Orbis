...
async def run_test():
    ...
    try:
        ...
        # -> Fill the onboarding fields (name and objective) and click 'INICIAR JORNADA' to complete onboarding so the app renders the main UI (sidebar).
        ...
        # -> Click the 'Finanças' sidebar button to open the Finance page and then verify the Finanças page content is visible.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/div/div[5]/nav/button[8]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the 'Finanças' sidebar button (interactive element index 1871) to open the Finanças page and then verify the Finanças page content is visible.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/div/div[5]/nav/button[8]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
