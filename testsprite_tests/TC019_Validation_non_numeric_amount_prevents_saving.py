...
async def run_test():
    ...
    try:
        ...
        # -> Fill the onboarding form (name and objective) and click 'INICIAR JORNADA' to enter the main app.
        ...
        # -> Click the 'Finanças' sidebar button (index 863) to open the Finanças page.
        frame = context.pages[-1]
        # Click element
