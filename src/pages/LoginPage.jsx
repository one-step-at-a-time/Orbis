...
export function LoginPage({ onLogin }) {
    ...
    return (
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 16, position: "relative", overflow: "hidden", background: "#0b0b1a" }}>
            <div style={{ position: "absolute", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(59, 89, 255, 0.12), transparent 70%)", top: "-10%", right: "-5%", filter: "blur(60px)" }} />
            <div style={{ position: "absolute", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(124, 58, 237, 0.08), transparent 70%)", bottom: "-5%", left: "-5%", filter: "blur(60px)" }} />

            <div className="card animate-slide-up" style={{ width: "100%", maxWidth: 440, padding: 40, position: "relative", zIndex: 1, background: "rgba(11,11,26,0.6)", border: "1px solid rgba(59, 89, 255, 0.3)", boxShadow: "0 0 40px rgba(59, 89, 255, 0.1)" }}>
                <div style={{ textAlign: "center", marginBottom: 32 }}>
                    <div className="glow-cyan animate-float" style={{ width: 64, height: 64, borderRadius: 20, background: "linear-gradient(135deg, var(--primary), var(--accent))", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
                        <Zap size={32} color="white" />
                    </div>
                    <h1 style={{ fontFamily: "var(--font-system)", fontSize: 26, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--primary)", textShadow: "var(--glow-primary)" }}>
                        THE SYSTEM
                    </h1>
